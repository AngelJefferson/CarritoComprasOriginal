-- =============================================================
-- Script FRESCO para DBCARRITOTEST
-- DROP completo + CREATE limpio de tablas, SPs, y seed data
-- =============================================================

USE [master]
GO

-- DROP la BD si existe y recrear de cero
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'DBCARRITOTEST')
BEGIN
...
AS BEGIN
    ...
    SELECT
        ...
        v.Contacto [Cliente], p.Nombre [Producto], p.Precio,
        dv.Cantidad, v.MontoTotal [Total], v.IdTransaccion
    FROM VENTA v
...
CREATE PROC sp_LoginCliente(
    ...
    END ELSE SET @Mensaje = 'Correo o clave incorrectos'
END
GO
...
CREATE PROC sp_ModificarCarrito(
...
CREATE PROC sp_ListarProductoTienda
AS BEGIN
    SELECT p.IdProducto, p.Nombre, p.Descripcion,
...
CREATE PROC sp_ObtenerDepartamentos
AS BEGIN
    SELECT IdDepartamento, Descripcion FROM DEPARTAMENTO
END
GO

CREATE PROC sp_ObtenerProvincias(
...
CREATE PROC sp_ObtenerDistritos(
...
PRINT '================================================'
PRINT 'DBCARRITOTEST creada exitosamente desde cero.'
PRINT '11 tablas, 29 SPs, datos seed completos.'
PRINT '================================================'
GO
